...
# Beschreibung: Erstellung einer einzigen Methode aus der inferenz_pipeline.ipynb. Die Methode ist essentiell 
# für die API und wird auch für den raspberry pi verwendet 
